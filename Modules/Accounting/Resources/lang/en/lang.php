...
return [
    ...
    'no_attachment_to_show' => 'no attachment',
    ...
    'accounts_name' => [
        ...
        "Utilities" => "Utilities",
        "Unrealised loss on securities, net of tax" => "Unrealised loss on securities, net of tax",
        "Undeposited Funds" => "Undeposited Funds",
        "Uncategorised Income" => "Uncategorised Income",
        "Uncategorised Expense" => "Uncategorised Expense",
        "Uncategorised Asset" => "Uncategorised Asset",
        "Unapplied Cash Payment Income" => "Unapplied Cash Payment Income",
        "Travel expenses - selling expense" => "Travel expenses - selling expense",
        "Travel expenses - general and admin expenses" => "Travel expenses - general and admin expenses",
        "Supplies" => "Supplies",
        "Subcontractors - COS" => "Subcontractors - COS",
        "Stationery and printing" => "Stationery and printing",
        "Short-term debit" => "Short-term debit",
        "Shipping and delivery expense" => "Shipping and delivery expense",
        ...
        "Rent or lease payments" => "Rent or lease payments",
        ...
        "Overhead - COS" => "Overhead - COS",
        "Other Types of Expenses-Advertising Expenses" => "Other Types of Expenses-Advertising Expenses",
        "Other selling expenses" => "Other selling expenses",
        "Other operating income (expenses)" => "Other operating income (expenses)",
        "Other general and administrative expenses" => "Other general and administrative expenses",
        "Other - COS" => "Other - COS",
        "Office expenses" => "Office expenses",
        "Meals and entertainment" => "Meals and entertainment",
        "Materials - COS" => "Materials - COS",
        "Management compensation" => "Management compensation",

        "Loss on disposal of assets" => "Loss on disposal of assets",
        "Loss on discontinued operations, net of tax" =>  "Loss on discontinued operations, net of tax",
        ...
        "Discounts given - COS" =>  "Discounts given - COS",
        "Direct labour - COS" => "العمالة المباشرة - تكلفة المبيعات",
        "Deferred tax assets" =>  "Deferred tax assets",
        "Cost of sales" => "Cost of sales",
        "Commissions and fees" =>  "Commissions and fees",
        "Change in inventory - COS" => "Change in inventory - COS",
        "Cash and cash equivalents" =>  "Cash and cash equivalents",
        "Billable Expense Income" => "Billable Expense Income",
        "Bank charges" => "Bank charges",

        "Bad debts" => "Bad debts",
        "Available for sale assets (short-term)" => "Available for sale assets (short-term)",
        "Assets held for sale" =>  "Assets held for sale",
        "Amortisation expense" =>  "Amortisation expense",
        "Allowance for bad debts" =>  "Allowance for bad debts",
        "Accumulated depreciation on property, plant and equipment" =>  "Accumulated depreciation on property, plant and equipment",
        "Accrued non-current liabilities" => "Accrued non-current liabilities",
    ...
    'sales_bill' => 'Sales bill migration',
    'sell_return_bill' => 'Sell return migration',
    'opening_stock' => 'Opening stock migration',
    'purchase_bill' => 'Purchase bill migration',
    'purchase_order_bill' => 'Purchase order bill migration',
    'purchase_return_bill' => 'Purchase return bill migration',
    'expens_bill' => 'Expens bill migration',
    ...
    'cost_center' => 'Coste center',
    'name_ar' => 'Arabic name',
    'name_en' => 'English name',
    'name' => 'Name',
    'account_center_number' => 'Account center number',
    'main_acc_name' => 'Main account name',
    'main_acc' => 'Main Account',
    ...
    'receipt_voucher_ent_date' => 'Receipt voucher end date',
    'receipt_voucher_date' => 'Receipt voucher date',
    'invoice_no' => 'Invoice no',
    'customer' => 'Customer',
    'amount' => 'Amount',
    'note' => 'Note',
    'payment_method' => 'Payment method',
    'create_receipt_voucher' => 'Create receipt voucher',
    'choose' => 'Choose',
    'value' => 'value',
    'voucher' => 'voucher',
    ...
    'print' => 'print',
    "requests" => "Requests",
    'please_add_the_accounting_department' => 'please add the accounting department',
    'all' => 'all',
    ...
    'payment_voucher_type' => 'Payment voucher type:',
    'operatio_type' => 'Operatio type',
    'migration_name' => 'Migration name',
    'payment_stauts' => 'Payment stauts',
    'payment_method' => 'Payment method',
    'migration_list' => 'Migration list',
    'migratio_status' => 'Migration status',
    'create_Journal_entry' => 'create Journal entry',
    'view_ledger' => 'View ldgere',
    'edit_accounts' => 'Edit accounts',
    'add_extra_accounts' => 'Add sub accounts',
    'active_accounts' => 'Activation account',
    'edit_cost_center' => 'Edit cost center',
    'delete_cost_center' => 'Delete cost center',
    'add_cost_center' => 'Add cost center',
    'opening_balances_delete' => 'Delete opening balance',
    'print_receipt_vouchers' => 'Print receipt vouchers',
    'add_receipt_vouchers' => 'Add receiot voucher',
    'print_payment_vouchers' => 'Print payment voucher',
    'add_payment_vouchers' => 'Add payment voucher',
    'journals' => 'Journals',
    'view_journal' => 'View journal',
    'view_transfer' => 'View transfer',
    'transaction_create_Journal_entry' => 'Create automatcily transaction journal entry',
    ...
    'Revenues' => 'Revenues',
    'operating expensesd' => 'operating expensesd',
    ...
    'period_locks_help' => 'Lock a calendar month to block new postings (journals, transfers, opening balances, depreciation) in that month.',
    'no_period_locks' => 'No periods locked.',
    'confirm_unlock_period' => 'Remove lock for this period?',
    'year' => 'Year',
    'month' => 'Month',
    'period_locked' => 'This accounting period is locked.',
    'journal_validation_missing_account' => 'Select an account for every line that has an amount.',
    'journal_validation_both_sides' => 'Each line may have only a debit or a credit, not both.',
    'journal_validation_zero_amount' => 'Each line with an account must have a non-zero debit or credit.',
    'journal_validation_unbalanced' => 'Total debits must equal total credits.',
    'journal_validation_empty' => 'Enter at least two lines with amounts.',
    'journal_invalid_accounts' => 'One or more accounts are invalid for this business.',
    'bank_reconciliation' => 'Bank reconciliation',
    'bank_gl_account' => 'Bank GL account',
    'statement_date' => 'Statement date',
    'statement_balance' => 'Statement ending balance',
    'book_balance' => 'Book balance',
    'no_bank_reconciliations' => 'No reconciliations yet.',
    'cleared' => 'Cleared',
    'cleared_balance_delta' => 'Cleared activity (signed, debit − credit)',
    'mark_reconciled' => 'Mark reconciled',
    'fixed_assets_module' => 'Fixed assets',
    'fixed_asset_inactive' => 'This fixed asset is inactive.',
    'depreciation_note' => 'Depreciation — :name (:y-:m)',
    'depreciation_already_or_zero' => 'Depreciation was already posted for this period, or the amount is zero.',
    'acquisition_date' => 'Acquisition date',
    'cost' => 'Cost',
    'useful_life_months' => 'Useful life (months)',
    'salvage_value' => 'Salvage value',
    'post_depreciation' => 'Post depreciation',
    'no_fixed_assets' => 'No fixed assets yet.',
