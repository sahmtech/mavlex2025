...
return [
    ...
    'attach_document' => 'إرفاق ملف',
    'history_edit' => 'سجل التعديلات',
    'attachment' => 'المرفقات',
    'no_attachment_to_show' => 'لا يوجد مرفقات',
    'attachment_view' => 'عرض المرفق',
    'edited_by' => 'عُدلت من قبل',
    ...
    'add_default_accounts_help' => 'هل تريد منا إنشاء حسابات افتراضية؟ يمكن تعديل/حذف الحسابات الافتراضية بعد إنشائها',
    ...
    'view_ledger' => 'عرض دفتر الاستاذ',
    'edit_accounts' => 'تعديل حساب',
    'add_extra_accounts' => 'إضافة حسابات فرعية',
    'active_accounts' => 'تنشيط حساب',
    'edit_cost_center' => 'تعديل مركز تكلفة',
    'delete_cost_center' => 'حذف مركز تكلفة',
    'add_cost_center' => 'إضافة مركز التكلفة',
    'opening_balances_delete' => 'حذف رصيد افتتاحي',
    'print_receipt_vouchers' => 'طباعة سندات القبض',
    'add_receipt_vouchers' => 'إضافة سندات القبض',
    'print_payment_vouchers' => 'طباعة سندات الصرف',
    'add_payment_vouchers' => 'إضافة سندات الصرف',
    'journals' => 'القيود اليومية',
    'view_journal' => 'عرض القيد الومي',
    ...
    'add_more_row' => 'إضافة مزيد من الصفوف',
    ...
    'configure_sales_auto_posting' => 'اضبط الترحيل الآلي',
    'configure_sales_auto_posting_help' => 'حدد حساب الدفع وحساب الإيداع الافتراضيين لكل فرع: قسم «المبيعات» يُستخدم عند توليد القيود من فواتير المبيعات، وقسم «مدفوعات المبيعات» عند تسجيل تحصيل المبيعات. تُحفظ الإعدادات مع بقية خريطة المحاسبة دون مسح إعدادات الشراء أو المصروفات.',
    'configure_sales_auto_posting_no_locations' => 'لا توجد فروع لهذا النشاط. أضف فرعاً من إعدادات الأعمال أولاً.',
    'add_auto_migration' => 'إنشاء الترحيلات الافتراضي',
    ...
    'accounts_name' => [
        ...
        'cost_goods_sold' => 'تكلفة البضاعة المباعة',
    ...
    'customers_and_suppliers_statement_of_account_report' => 'تقرير كشف حساب العملاء والموردين',
    'suppliers_and_customers' => 'الموردين والعملاء',
    'all' => 'الكل',
    'total_for_all_pages' => 'الإجمالي لكل الصفحات',
    ...
    'add_auto_migration_help' => 'هل تريد منا إنشاء الاعدادات الافتراضية الخاصة بالترحيل الالي؟ يمكنك تنشيط الترحيلات بعد إنشائها وتحديد القيود المراد ترحيلها',
    'add_new_auto_migration' => 'إضافة الاعدادات الافتراضية للترحيل الالي',
    'sales_bill' => 'ترحيل فاتورة مبيعات',
    'sell_return_bill' => 'ترحيل فواتير مردود المبيعات',
    'opening_stock' => 'ترحيل افتتاح مخزون',
    'purchase_bill' => 'ترحيل فواتير المشتريات',
    'purchase_order_bill' => 'ترحيل فواتير طلبات الشراء',
    'purchase_return_bill' => 'ترحيل عوائد الشراء',
    'expens_bill' => 'ترحيل المصروف',
    'sell_transfer' => 'ترحيل نقل البيع',
    'purchase_transfer' => 'ترحيل نقل الشراء',
    'payroll' => 'ترحيل كشف الرواتب',
    'opening_balance' => 'ترحيل الارصدة الافتتاحية',
    ...
    'migration_name' => 'اسم الترحيل',
    'payment_stauts' => 'حالة الدفع',
    ...
    'other_revenues' => 'الايرادات الأخرى',
    'other_expenses' => 'المصاريف الأخرى',
    'operating_expense' => 'المصاريف التشغيلية',
    'total_operating_expense' => 'اجمالي المصاريف التشغيلية',
    'total_other_revenues' => 'اجمالي الايرادات الاخرى',
    'total_other_expenses' => 'اجمالي المصاريف الاخرى',
    'total_cost_goods_sold' => 'اجمالي تكلفة البضاعة المباعة',
    'gross_profit' => 'اجمالي الربح',
    'income_from_operation' => 'الدخل من عمليات التشغيل',
    'income_before_tax' => 'الدخل بدون ضريبة',
    'net_income' => 'صافي الدخل',
    'cost_goods_sold' => 'تكلفة البضاعة المباعة',

    'period_locks' => 'إقفال الفترات المحاسبية',
    'period_locks_help' => 'اقفل شهراً تقويمياً لمنع الترحيل (القيود اليومية، التحويلات، الأرصدة الافتتاحية، الإهلاك) في ذلك الشهر.',
    'no_period_locks' => 'لا توجد فترات مقفلة.',
    'confirm_unlock_period' => 'إزالة الإقفال للفترة؟',
    'year' => 'السنة',
    'month' => 'الشهر',
    'period_locked' => 'هذه الفترة المحاسبية مقفلة.',
    'journal_validation_missing_account' => 'اختر حساباً لكل سطر يحتوي مبلغاً.',
    'journal_validation_both_sides' => 'كل سطر يجب أن يكون له مدين أو دائن فقط، وليس الاثنين.',
    'journal_validation_zero_amount' => 'كل سطر مرتبط بحساب يجب أن يكون له مدين أو دائن غير صفر.',
    'journal_validation_unbalanced' => 'يجب أن يتساوى إجمالي المدين مع إجمالي الدائن.',
    'journal_validation_empty' => 'أدخل سطرين على الأقل بمبالغ.',
    'journal_invalid_accounts' => 'أحد الحسابات أو أكثر غير صالح لهذا النشاط.',
    'bank_reconciliation' => 'تسوية بنكية',
    'bank_gl_account' => 'حساب البنك في الأستاذ العام',
    'statement_date' => 'تاريخ كشف الحساب',
    'statement_balance' => 'رصيد نهاية الكشف',
    'book_balance' => 'رصيد الدفاتر',
    'no_bank_reconciliations' => 'لا توجد تسويات بعد.',
    'cleared' => 'مسوّى',
    'cleared_balance_delta' => 'حركة المسوّاة (موقعة، مدين − دائن)',
    'mark_reconciled' => 'اعتبارها مسوّاة',
    'fixed_assets_module' => 'أصول ثابتة',
    'fixed_asset_inactive' => 'هذا الأصل غير نشط.',
    'depreciation_note' => 'إهلاك — :name (:y-:m)',
    'depreciation_already_or_zero' => 'تم ترحيل الإهلاك لهذه الفترة أو المبلغ صفر.',
    'acquisition_date' => 'تاريخ الاقتناء',
    'cost' => 'التكلفة',
    'useful_life_months' => 'العمر الإنتاجي (بالأشهر)',
    'salvage_value' => 'القيمة المتبقية',
    'post_depreciation' => 'ترحيل إهلاك',
    'no_fixed_assets' => 'لا توجد أصول ثابتة بعد.',
