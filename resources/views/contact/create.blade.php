  ...
  @endphp
    ...
    <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
                {!! Form::label('plot_identification', __('business.plot_identification') . ':') !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-map-marker"></i>
                    </span>
                    {!! Form::text('plot_identification', null, ['class' => 'form-control', 'placeholder' => __('business.plot_identification')]); !!}
                </div>
            </div>
          </div>
