@if (!empty($receipt_details->invoice_heading))
    <p class="text-right text-muted-imp" style="font-weight: bold; font-size: 18px !important">
...
<div class="row invoice-info">
    ...
    <div class="col-md-6 invoice-col width-50 color-555">
        ...
        @if (!empty($receipt_details->logo))
            <img src="{{ $receipt_details->logo }}" class="img" style="text-right max-width:150px; height:150px;">
...
<div class="row invoice-info color-555" style=" page-break-before: always; page-break-inside: avoid !important">
    <div class="col-md-6 invoice-col width-50">
