        ...
        @component('components.widget', ['class' => 'box-primary'])
                ...
                <div class="col-md-9">
                    ...
                    @if (in_array('allergens', $enabled_modules))
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'allergen.view', in_array('allergen.view', $role_permissions), [
                                        'class' => 'input-icheck',
                                    ]) !!} {{ __('role.allergen.view') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'allergen.create', in_array('allergen.create', $role_permissions), [
                                        'class' => 'input-icheck',
                                    ]) !!} {{ __('role.allergen.create') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'allergen.edit', in_array('allergen.edit', $role_permissions), [
                                        'class' => 'input-icheck',
                                    ]) !!} {{ __('role.allergen.edit') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'allergen.delete', in_array('allergen.delete', $role_permissions), [
                                        'class' => 'input-icheck',
                                    ]) !!} {{ __('role.allergen.delete') }}
                                </label>
                            </div>
                        </div>
                    @endif
                            ...
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        ...
                                        in_array('edit_purchase_payment', $role_permissions),
                                        ['class' => 'input-icheck'],
                                    ) !!}
                            ...
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        ...
                                        in_array('delete_purchase_payment', $role_permissions),
                                        ['class' => 'input-icheck'],
                                    ) !!}
                            ...
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        ...
                                        ['class' => 'input-icheck'],
                                    ) !!} {{ __('lang_v1.create_purchase_requisition') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        ...
                                        ['class' => 'input-icheck'],
                                    ) !!} {{ __('lang_v1.delete_purchase_requisition') }}
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        ...
                                        in_array('purchase_order.create', $role_permissions),
                                        ['class' => 'input-icheck'],
                            ...
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        ...
                                        in_array('purchase_order.update', $role_permissions),
                                        ['class' => 'input-icheck'],
                            ...
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        ...
                                        in_array('purchase_order.delete', $role_permissions),
                                        ['class' => 'input-icheck'],
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'edit_pos_payment', in_array('edit_pos_payment', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'print_invoice', in_array('print_invoice', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'disable_draft', in_array('disable_draft', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!}
                        ...
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('disable_express_checkout', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'disable_discount', in_array('disable_discount', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!}
                        ...
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('disable_suspend_sale', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'disable_credit_sale', in_array('disable_credit_sale', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'disable_quotation', in_array('disable_quotation', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'disable_card', in_array('disable_card', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!}
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                            ...
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        ...
                                        in_array('view_paid_sells_only', $role_permissions),
                                        ['class' => 'input-icheck'],
                    ...
                    <!-- <div class="col-md-12">
                            <div class="checkbox">
                              <label>
                                {!! Form::checkbox('permissions[]', 'edit_sell_payment', in_array('edit_sell_payment', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!}
                          ...
                          <div class="col-md-12">
                            <div class="checkbox">
                              <label>
                                {!! Form::checkbox('permissions[]', 'delete_sell_payment', in_array('delete_sell_payment', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!}
                        ...
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('access_own_sell_return', $role_permissions),
                                    ['class' => 'input-icheck'],
                        ...
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('access_pending_shipments_only', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!}
                        ...
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('access_commission_agent_shipping', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!}
                        ...
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('view_product_stock_value', $role_permissions),
                                    ['class' => 'input-icheck'],
                        ...
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('edit_account_transaction', $role_permissions),
                                    ['class' => 'input-icheck'],
                        ...
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('delete_account_transaction', $role_permissions),
                                    ['class' => 'input-icheck'],
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <button type="submit"
                        class="tw-dw-btn tw-dw-btn-primary tw-dw-btn-lg tw-text-white">@lang('messages.update')</button>
                </div>
            </div>
