<div class="pos-tab-content">
    <div class="row">
        ...
        @for($i = 1; $i <= 20; $i++) <div class="col-sm-4">
            <div class="form-group custom_label_product_div">
                {!! Form::label('product_custom_field_label_' . $i, __('lang_v1.custom_field', ['number' => $i])); !!}

                <div class="input-group">
                    {!! Form::text('custom_labels[product][custom_field_' . $i . ']', !empty($custom_labels['product']['custom_field_' . $i]) ? $custom_labels['product']['custom_field_' . $i] : null,
                    ['class' => 'form-control', 'id' => 'product_custom_field_label_' . $i]); !!}


                    <div class="input-group-addon">
                        
                        <select class="custom_labels_products" name="custom_labels[product_cf_details][{{$i}}][type]">
                            <option value="">@lang('lang_v1.field_type')</option>
                            <option value="text" 
                                @if (!empty($custom_labels['product_cf_details'][$i]['type']) && $custom_labels['product_cf_details'][$i]['type'] == 'text') selected @endif>
                                @lang('lang_v1.text')
                            </option>
                            <option value="date"
                                @if (!empty($custom_labels['product_cf_details'][$i]['type']) && $custom_labels['product_cf_details'][$i]['type'] == 'date') selected @endif>
                                @lang('lang_v1.datepicker')
                            </option>
                            <option value="dropdown"
                                @if (!empty($custom_labels['product_cf_details'][$i]['type']) && $custom_labels['product_cf_details'][$i]['type'] == 'dropdown') selected @endif>
                                @lang('lang_v1.dropdown')
                            </option>
                        </select>
                    </div>
                </div>

                <div class="form-group custom_label_product_dropdown @if (empty($custom_labels['product_cf_details'][$i]['type']) || $custom_labels['product_cf_details'][$i]['type'] != 'dropdown') hide @endif">
                    <textarea name="custom_labels[product_cf_details][{{$i}}][dropdown_options]" cols="36" rows="2" placeholder="@lang('lang_v1.enter_dropdown_values')">@if(!empty($custom_labels['product_cf_details'][$i]['dropdown_options'])){{$custom_labels['product_cf_details'][$i]['dropdown_options']}}@endif</textarea>
                </div>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            {!! Form::text('custom_labels[sell][custom_field_1]', $custom_labels['sell']['custom_field_1'] ?? null,
            ...
            <div class="input-group-addon">
                <label>
                    <input type="checkbox" 
                           ...
                           value="1"
                           @if(!empty($custom_labels['sell']['is_custom_field_1_required']) && $custom_labels['sell']['is_custom_field_1_required']==1) checked @endif>
                    @lang('lang_v1.is_required')
                </label>
            </div>

            <div class="input-group-addon">
                <select class="sell_custom_field_1_type" name="custom_labels[sell][custom_field_1_details][type]">
                    <option value="">@lang('lang_v1.field_type')</option>
                    <option value="text"
                        @if(($custom_labels['sell']['custom_field_1_details']['type'] ?? '') == 'text') selected @endif>
                        @lang('lang_v1.text')
                    </option>
                    <option value="date"
                        @if(($custom_labels['sell']['custom_field_1_details']['type'] ?? '') == 'date') selected @endif>
                        @lang('lang_v1.datepicker')
                    </option>
                    <option value="dropdown"
                        @if(($custom_labels['sell']['custom_field_1_details']['type'] ?? '') == 'dropdown') selected @endif>
                        @lang('lang_v1.dropdown')
                    </option>
                </select>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <div class="input-group-addon">
                   ...
                   <div class="input-group-addon">
                <select class="sell_custom_field_2_type" name="custom_labels[sell][custom_field_2_details][type]">
                    <option value="">@lang('lang_v1.field_type')</option>
                    <option value="text"
                        @if(($custom_labels['sell']['custom_field_2_details']['type'] ?? '') == 'text') selected @endif>
                        @lang('lang_v1.text')
                    </option>
                    <option value="date"
                        @if(($custom_labels['sell']['custom_field_2_details']['type'] ?? '') == 'date') selected @endif>
                        @lang('lang_v1.datepicker')
                    </option>
                    <option value="dropdown"
                        @if(($custom_labels['sell']['custom_field_2_details']['type'] ?? '') == 'dropdown') selected @endif>
                        @lang('lang_v1.dropdown')
                    </option>
                </select>
            </div>
