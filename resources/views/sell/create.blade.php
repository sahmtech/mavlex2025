...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
    ...
    <div class="form-group">
        ...
        @php
            $field1_type = $custom_labels['sell']['custom_field_1_details']['type'] ?? 'text';
        @endphp

        @if($field1_type == 'date')
            {!! Form::date('custom_field_1', null, [
                'class' => 'form-control',
                'placeholder' => $custom_field_1_label,
                'required' => $is_custom_field_1_required
            ]) !!}
        @elseif($field1_type == 'dropdown')
            {!! Form::select(
                'custom_field_1',
                $custom_labels['sell']['custom_field_1_details']['dropdown_options'] ?? [],
                null,
                [
                    'class' => 'form-control',
                    'placeholder' => $custom_field_1_label,
    ...
    <div class="form-group">
        ...
        @php
            $field1_type = $custom_labels['sell']['custom_field_2_details']['type'] ?? 'text';
        @endphp

        @if($field1_type == 'date')
            {!! Form::date('custom_field_2', null, [
                'class' => 'form-control',
        ...
        @elseif($field1_type == 'dropdown')
            {!! Form::select(
                'custom_field_2',
                $custom_labels['sell']['custom_field_2_details']['dropdown_options'] ?? [],
                null,
                [
                    'class' => 'form-control',
                    'placeholder' => $custom_field_2_label,
