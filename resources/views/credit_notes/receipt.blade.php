	...
	<thead>
		<tr>
			<td>
			 ...
			 <p class="text-right text-muted-imp" style="font-weight: bold; font-size: 18px !important">إشعار دائن - Credit Note</p>
...
<div class="row invoice-info">
	...
	<div class="col-md-6 invoice-col width-50 color-555">
		...
		@if(!empty($receipt_details->logo))
			<img src="{{$receipt_details->logo}}" class="img" style="max-height:80px; margin-bottom:10px;">
			<br/>
		@endif
	...
	<div class="col-md-6 invoice-col width-50">
		...
		<p class="text-right font-30">
				...
				<span class="pull-left">رقم الإشعار</span>
