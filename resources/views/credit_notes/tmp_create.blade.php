...
<section class="content-header no-print">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('lang_v1.credit_notes')</h1>
    <!-- <ol class="breadcrumb">
...
<section class="content no-print">
	...
	{!! Form::open(['url' => action([\App\Http\Controllers\SellReturnController::class, 'store']), 'method' => 'post', 'id' => 'credit_notes_form' ]) !!}
	...
	<div class="box box-solid"><!--box start-->
		...
		<div class="row">
		<div class="col-sm-12">
			<button type="button" id="submit_credit_notes_form" class="btn btn-primary pull-right btn-flat">@lang('messages.save')</button>
		</div>
		</div>
