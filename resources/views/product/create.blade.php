            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group allergens-select-wrapper">
                        ...
                        {!! Form::select(
                            'allergens[]',
                            $allergens->pluck('name', 'id'),
                            isset($duplicate_product) ? $duplicate_product->allergens->pluck('id')->toArray() : null,
                            [
                        ...
                        <small class="text-muted">{{ __('product.select_all_that_apply') }}</small>
                    </div>
                </div>
                                ...
                                @elseif($cf_type == 'dropdown')
                                    ...
                                    <select name="{{ $db_field_name }}" id="{{ $db_field_name }}" class="form-control select2">
                                        ...
                                        @foreach ($dropdown as $option)
                                            <option value="{{ $option }}"
                                                @if (!empty($duplicate_product->$db_field_name) && $option == $duplicate_product->$db_field_name) selected @endif>
                                                {{ $option }}
                                            </option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="btn-group">
                        @if ($selling_price_group_count)
                            <button type="submit" value="submit_n_add_selling_prices"
                                class="tw-dw-btn tw-dw-btn-warning tw-dw-btn-lg tw-text-white submit_product_form">@lang('lang_v1.save_n_add_selling_price_group_prices')</button>
                        @endif
