    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        {!! Form::checkbox('attendance_geofence_enabled', 1, (bool) old('attendance_geofence_enabled'), ['class' => 'input-icheck', 'id' => 'attendance_geofence_enabled_create']); !!}
                        <label for="attendance_geofence_enabled_create" class="tw-mb-0">@lang('business.attendance_geofence_enable')</label>
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="form-group">
