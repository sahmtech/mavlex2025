    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title no-print">
                ...
                @elseif(in_array($transaction->type, ['sell', 'sell_return','credit_notes']))
