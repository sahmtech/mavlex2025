...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/sell-return/add/{id}', [SellReturnController::class, 'add']);
     ...
     Route::resource('credit-notes', CreditNotesController::class);
     Route::post('credit-notes-store', [CreditNotesController::class, 'store']);
    Route::get('credit-notes/get-product-row', [CreditNotesController::class, 'getProductRow']);
    Route::get('/credit-notes/print/{id}', [CreditNotesController::class, 'printInvoice']);
    Route::get('/credit-notes/add/{id}', [CreditNotesController::class, 'add']);
